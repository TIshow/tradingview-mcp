...
| 状態 | |
|---|---|
| ✅ 完了 | 憲章・研究プロトコル・文献の整備／選択バイアスの実証／リプレイと盲検装置の検証／テンプレート3種／研究契約の起草 |
| 🔜 次 | データ源の確定（[#2](https://github.com/TIshow/tradingview-mcp/issues/2)）→ 契約の凍結 → **フォワード記録の開始**（[#27](https://github.com/TIshow/tradingview-mcp/issues/27)） |
